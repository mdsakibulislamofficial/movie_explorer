...
Map<int, Color> colorSwatch = {
  50: const Color.fromRGBO(2, 121, 161, .1),
  100: const Color.fromRGBO(2, 121, 161, .2),
  200: const Color.fromRGBO(2, 121, 161, .3),
  300: const Color.fromRGBO(2, 121, 161, .4),
  400: const Color.fromRGBO(2, 121, 161, .5),
  500: const Color.fromRGBO(2, 121, 161, .6),
  600: const Color.fromRGBO(2, 121, 161, .7),
  700: const Color.fromRGBO(2, 121, 161, .8),
  800: const Color.fromRGBO(2, 121, 161, .9),
  900: const Color.fromRGBO(2, 121, 161, 1),
};
...
abstract class AppColors {
  ...
  static MaterialColor colorPrimarySwatch =
      MaterialColor(0xFF070926, colorSwatch);
  static const Color colorPrimary = Color(0xFF070926);
  static const Color colorAccent = Color(0xFF070926);
  ...
  static const Color textColorCyan = Color(0xFF070926);
